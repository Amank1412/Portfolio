    ...
    <section className="w-full py-12 md:py-24 lg:py-32">
      <div className="container px-4 md:px-6">
        <div className="space-y-6">
          <h1 className="text-3xl font-bold text-neutral-800 dark:text-white ">Blogs</h1>
          ...
          <CardContainer className="inter-var">
            <motion.div 
              ...
              onClick={() => window.open('https://dev.to/adityajha2005/from-clueless-freshman-to-tech-intern-my-unexpected-journey-d29', '_blank')}
            >
              <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-transparent dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                ...
                >
                  From Clueless Freshman to Tech Intern: My Unexpected Journey
                </CardItem>
            ...
            <motion.div 
              ...
              animate={{ scale: 1 }}
              transition={{ duration: 0.5, ease: "easeOut" }}
              onClick={() => window.open('https://dev.to/adityajha2005/get-started-with-machine-learning-38o8', '_blank')}
            >
              <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-transparent dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-auto rounded-xl p-6 border">
                <CardItem
                  translateZ="50"
