          ...
          <motion.div initial={{ scale: 0 }} animate={{ scale: 1 }}
            transition={{ duration: 0.5, ease: "easeOut" }}>
              ...
              <CardBody className="bg-gray-50 relative group/card  dark:hover:shadow-2xl dark:hover:shadow-emerald-500/[0.1] dark:bg-transparent dark:border-white/[0.2] border-black/[0.1] w-auto sm:w-[30rem] h-[550px] rounded-xl p-6 border"> {/* Fixed height to 600px */}
                ...
                >
                  KOSU - AI & Web3-Powered Talent & Hackathon Platform
                </CardItem>
                <CardItem
                  as="p"
                  translateZ="60"
                ...
                >
                  Next.js, TypeScript, NLP (Hugging Face, Gemini API), Move AI , Petra Wallet, MongoDB
                </CardItem>
                <CardItem
                  translateZ="100"
                  rotateX={0}
                ...
                <div className="flex justify-between items-center mt-20">
                  ...
                  <CardItem
                    ...
                    translateX={40}
                    as="a"
                    href="https://github.com/adityajha2005/kosu"
